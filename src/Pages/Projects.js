                    ...
                    projects.map((project, index) => (
                        ...
                        <div key={index} className='flex flex-col mt-14'>
                            <h2 className='flex-wrap flex gap-2 mb-2.5'>
                                ...
                                <span className='shadow-light-inner dark:shadow-dark-inner text-red py-1 px-4 rounded-full text-sm text-gray-400 ltr:font-en rtl:font-fa'>
                                    {project.date}
                                </span>
                            </h2>
                            ...
                            <div className='w-full h-1.5 my-3 shadow-light-inner dark:shadow-dark-inner rounded-full'/>
                            {
                                project.descriptions.map((paragraph, index) => (
                                    <p key={index}
                                       className={`mb-2 text-md dark:text-gray-400 text-gray-500 ltr:font-en rtl:font-fa leading-7`}>{paragraph}</p>
                                ))
                            }
